...
<<<<<<< HEAD
    # Volumenstrom-Sollwerte je Lüftungsstufe (80-300 m³/h).
    "volumenstrom_reduziert": RegisterDef(154, scale=1.0, writable=True),
    "volumenstrom_nennlueftung": RegisterDef(155, scale=1.0, writable=True),
    "volumenstrom_intensiv": RegisterDef(156, scale=1.0, writable=True),
